...
var PokemonsService = /** @class */ (function () {
    ...
    PokemonsService.prototype.updatePokemon = function (pokemon) {
        ...
        return this.http.put(this.pokemonsUrl, pokemon, httpOptions).pipe(operators_1.tap(function (_) { return _this.log("updtaed pokemon id=" + pokemon.id); }), operators_1.catchError(this.handleError('updatePokemon')));
    };
